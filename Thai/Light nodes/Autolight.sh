...
celestia light init --p2p.network blockspacerace >> /root/.celestia-light-blockspacerace-0/keys/my_celes_key.log
}
...
options=("Install" "Get Node ID" "Get Wallet" "Restart" "Uninstall" "Quit")
